...
WEIGHTS_FILE = WEIGHTS_DIR + "weights-history.h5"
STEERSTATS_FILE = WEIGHTS_DIR + "steerstats-history.npz"
THR_MAX = 1604
...
model.add(Dense(3+1, activation='linear', kernel_initializer='lecun_uniform'))
